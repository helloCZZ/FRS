...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalLayout.setSpacing(174)
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600; color:#0055ff;\">已经人脸识别的用户</span></p></body></html>"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Dialog", "卡      号"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Dialog", "姓      名"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "用  户 组"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Dialog", "使用时间"))
        self.label_2.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600; color:#0055ff;\">未人脸识别的用户</span></p></body></html>"))
